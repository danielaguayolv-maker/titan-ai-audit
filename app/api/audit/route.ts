        ...
        input: [
          {
            role: "system",
            content:
              `You are Titan Visibility OS, a premium visibility intelligence and execution system for creators and businesses. Return only structured JSON that matches the schema. Be specific, practical, concise, and lead-ready. Generate a realistic overall visibility score from 0 to 100, a matching letter grade, and 4 to 6 category scores. Include 3 to 5 quick wins, 4 to 6 content recommendations, 4 to 6 report findings, and 3 to 5 next steps. Do not invent private facts. If live profile data is provided, prioritize it. If live profile data is unavailable, clearly operate from URL-only mode plus optional user-provided context. Make every diagnosis explain why the issue hurts performance, where attention is being lost, what emotional or visual trigger is missing, and what should change in timing, sequencing, pacing, CTA placement, or audience psychology. Avoid shallow phrases like "needs stronger hooks" or "CTA lacks clarity" unless you immediately explain the behavioral cause and tactical fix. ${getPlatformInstructions(formData.platform)}`
          },
          {
            role: "user",
